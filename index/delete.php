...
$statement = $pdo->prepare("DELETE FROM termine WHERE id = ?");
...
<!DOCTYPE html>
<html>
  <title>Gelöscht :: Kalender :: SyCa</title>
  <?php
    ...
    <div class="limiter limiter-show">
      <div class="container-login100">
        <div class="wrap-login100">
          <span class="login100-form-title" style="color: #72af2f;">Termin gelöscht</span>
